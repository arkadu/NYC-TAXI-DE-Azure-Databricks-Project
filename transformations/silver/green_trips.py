# Silver: Green Taxi Trips - Cleaned, Standardized, Deduplicated
...
@dp.table(
    name="nyctaxi_databricks.silver.green_trips",
    comment="Cleaned and deduplicated green taxi trips with standardized column names",
...
def green_trips():
    return (
        spark.readStream.table("nyctaxi_databricks.bronze.green_trips_raw")
